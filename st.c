...
tscrolldown(int orig, int n, int copyhist)
{
	...
	if (copyhist) {
		term.histi = (term.histi - 1 + HIST) % HIST;
...
tresize(int col, int row)
{
	...
	for (i = 0; i < HIST; i++) {
		term.hist[i] = xrealloc(term.hist[i], col * sizeof(Glyphy));
